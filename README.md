...
Приложение принимает URL сайта, выполняет анализ страницы и извлекает основные SEO-метаданные: title, h1 и description, после чего сохраняет результаты в базу данных. Проект демонстрирует навыки разработки веб-приложений на Javalin, работы с SQL-запросами и базами данных, создания HTML-шаблонов с использованием Bootstrap, а также написания тестов, включая unit- и integration-тестирование с применением Mockito.

Можно и чуть короче, например для README или резюме:

Проект представляет собой анализатор веб-страниц: пользователь вводит URL, приложение получает данные страницы (title, h1, description) и сохраняет их в базу данных. В ходе разработки использовались Javalin, SQL, Bootstrap и тестирование с Mockito.
